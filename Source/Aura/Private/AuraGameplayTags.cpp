...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.Attributes_Secondary_CriticalHitDamage = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Attributes.Secondary.CriticalHitDamange"), FString("Bonus damage added when a critical hit is scored"));
